...
class PipelineConfig:
    """Runtime configuration for a single drawing run (SDIE v3.3)."""
    ...
    enable_deepseek_component_classification: bool = False
    ...
    deepseek_model: str = "auto"  # auto | deepseek-chat | deepseek-reasoner
